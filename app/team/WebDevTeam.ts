...
export const webdevTeamData: TeamMember[] = [
 {
    id: 1,
  ...
  },
 {
  ...
  image: 'https://images.prismic.io/ieeemuj/aGth4EMqNJQqHlkc_Ekaagra_cis_CC_25-26.jpeg?auto=format,compress',
  socialMedia: {
    linkedin: 'www.linkedin.com/in/ekaagragupta',
